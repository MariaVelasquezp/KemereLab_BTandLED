...
#define CYBLE_FREQAMP_SERVICE_INDEX   (0x00u) /* Index of FreqAmp service in the cyBle_customs array */
#define CYBLE_FREQAMP_FREQUENCY_CHAR_INDEX   (0x00u) /* Index of Frequency characteristic */
#define CYBLE_FREQAMP_FREQUENCY_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_FREQAMP_FREQUENCY_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_FREQAMP_AMPLITUDE_CHAR_INDEX   (0x01u) /* Index of Amplitude characteristic */
#define CYBLE_FREQAMP_AMPLITUDE_AMPLITUDECCCD_DESC_INDEX   (0x00u) /* Index of amplitudecccd descriptor */
#define CYBLE_FREQAMP_AMPLITUDE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */


#define CYBLE_FREQAMP_SERVICE_HANDLE   (0x0010u) /* Handle of FreqAmp service */
#define CYBLE_FREQAMP_FREQUENCY_DECL_HANDLE   (0x0011u) /* Handle of Frequency characteristic declaration */
#define CYBLE_FREQAMP_FREQUENCY_CHAR_HANDLE   (0x0012u) /* Handle of Frequency characteristic */
#define CYBLE_FREQAMP_FREQUENCY_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_FREQAMP_FREQUENCY_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0014u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_FREQAMP_AMPLITUDE_DECL_HANDLE   (0x0015u) /* Handle of Amplitude characteristic declaration */
#define CYBLE_FREQAMP_AMPLITUDE_CHAR_HANDLE   (0x0016u) /* Handle of Amplitude characteristic */
#define CYBLE_FREQAMP_AMPLITUDE_AMPLITUDECCCD_DESC_HANDLE   (0x0017u) /* Handle of amplitudecccd descriptor */
#define CYBLE_FREQAMP_AMPLITUDE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0018u) /* Handle of Characteristic User Description descriptor */
