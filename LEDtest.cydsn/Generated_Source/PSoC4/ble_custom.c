...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* FreqAmp service */
    {
        0x0010u, /* Handle of the FreqAmp service */ 
        {

            /* Frequency characteristic */
            {
                0x0012u, /* Handle of the Frequency characteristic */ 
            ...
            {
                0x0016u, /* Handle of the Amplitude characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0017u, /* Handle of the amplitudecccd descriptor */ 
