// ======================================================================
// LEDtest.v generated from TopDesign.cysch
// 08/30/2023 at 21:48
...
module BLE_v3_66_0 (
	...
	cy_clock_v1_0
		#(.id("30d31b54-7a4e-420a-86ab-ecfab0cedbf7/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__BOOST_net;
	wire [0:0] tmpFB_0__BOOST_net;
	wire [0:0] tmpIO_0__BOOST_net;
	wire [0:0] tmpINTERRUPT_0__BOOST_net;
	electrical [0:0] tmpSIOVREF__BOOST_net;

	cy_psoc3_pins_v1_10
		#(.id("fbec09ad-f35d-48cf-9f55-84d3d0aecffd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		BOOST
		 (.oe(tmpOE__BOOST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BOOST_net[0:0]}),
		  .io({tmpIO_0__BOOST_net[0:0]}),
		  .siovref(tmpSIOVREF__BOOST_net),
		  .interrupt({tmpINTERRUPT_0__BOOST_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BOOST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
